...
def parse():
    ...
    parser.add_argument('-test_file',default='../data/task2.val.src',help='testing src file')
    parser.add_argument('-test_tgt_file',default='../data/task2.val.tgt',help='testing tgt file')
